...
*
* ShareSystemActionExecutor.java
 ...
 * @version 0.1
 */
public class ShareSystemActionExecutor extends ContentAwareSystemActionExecutor {

	/**
	 * @param context
	 */
	public ShareSystemActionExecutor(Activity context) {
		super(context, SystemAction.SHARE);
	}
