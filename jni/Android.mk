...
VUFORIA_HOME := ../../../vuforia-sdk-android-2-0-30
...
LOCAL_SRC_FILES = $(VUFORIA_HOME)/build/lib/$(TARGET_ARCH_ABI)/libQCAR.so
LOCAL_EXPORT_C_INCLUDES := $(VUFORIA_HOME)/build/include
...
LOCAL_SRC_FILES := ArActivity.cpp SampleUtils.cpp Texture.cpp
